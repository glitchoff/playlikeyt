...
import { getVideos, VideoMetadata, updateVideo } from '@/lib/indexeddb';
      ...
      <div className="flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto">
        ...
        <div className="lg:w-[69%] flex-shrink-0">
          ...
          <div className="px-1">
            ...
            <div className="flex flex-wrap items-center justify-between border-b border-gray-200 dark:border-[#303030] pb-4 mb-4 gap-4">
        ...
        {/* Right Sidebar (30%) */}
        <div className="lg:w-[30%] flex-col gap-3 hidden lg:flex">
